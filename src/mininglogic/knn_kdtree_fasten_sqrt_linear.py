...
if __name__ == '__main__':
    ...
    if(useWeight != 0):
        ...
        print "ratio = \n", ratio
        trainVector[:,0] =  trainVector[:,0] * math.sqrt(math.fabs(ratio[0])) # -0.12748538
        trainVector[:,1] =  trainVector[:,1] * math.sqrt(math.fabs(ratio[1])) # 0.57295446
        trainVector[:,2] =  trainVector[:,2] * math.sqrt(math.fabs(ratio[2])) # 0.27336366
        trainVector[:,3] =  trainVector[:,3] * math.sqrt(math.fabs(ratio[3])) # 0.22940873
        trainVector[:,4] =  trainVector[:,4] * math.sqrt(math.fabs(ratio[4])) # 0.01308849
        trainVector[:,5] =  trainVector[:,5] * math.sqrt(math.fabs(ratio[5])) # 0.13693268
        trainVector[:,6] =  trainVector[:,6] * math.sqrt(math.fabs(ratio[6])) # 0.18386892
        testVector[:,0] =  testVector[:,0] * math.sqrt(math.fabs(ratio[0])) # -0.12748538
        testVector[:,1] =  testVector[:,1] * math.sqrt(math.fabs(ratio[1])) # 0.57295446
        testVector[:,2] =  testVector[:,2] * math.sqrt(math.fabs(ratio[2])) # 0.27336366
        testVector[:,3] =  testVector[:,3] * math.sqrt(math.fabs(ratio[3])) # 0.22940873
        testVector[:,4] =  testVector[:,4] * math.sqrt(math.fabs(ratio[4])) # 0.01308849
        testVector[:,5] =  testVector[:,5] * math.sqrt(math.fabs(ratio[5])) # 0.13693268
        testVector[:,6] =  testVector[:,6] * math.sqrt(math.fabs(ratio[6])) # 0.18386892
    # print testVector
    ...
    for i in range(TestsampleNum):
        ...
        if len(np.unique(neighbours_label)) == 1:
            predictedLabel[i] = neighbours_label[0]
        else:
            clf.fit(neighbours, neighbours_label)
            predictedLabel[i] = clf.predict(testVector[i,:])
